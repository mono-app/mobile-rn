...
class MyClassScreen extends React.PureComponent {
  ...
  loadClasses = async () => {
    ...
    const classList = await ClassAPI.getUserActiveClasses(this.props.currentSchool.id, this.props.currentStudent.id);
...
export default withTranslation()(withCurrentStudent(MyClassScreen))
