...
const INITIAL_STATE = { isLoadingProfile: true, student: null, status: "" , schoolId: "1hZ2DiIYSFa5K26oTe75"  }
      ...
      <View style={{ backgroundColor: "#E8EEE8", paddingTop: 16 }}>
        <ScrollView>
          <PeopleProfileHeader
            ...
            status= {"NIM " + ((!this.state.student.noInduk)?this.state.student.noInduk:"-")}/>


          <View style={{ marginTop:16, paddingHorizontal: 16, paddingTop:16, backgroundColor: "#fff" }}>
